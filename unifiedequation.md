...
![PH_k(X_{\text{smooth}})](https://latex.codecogs.com/svg.image?PH_k(X_{\text{smooth}})) = ![\bigcup](https://latex.codecogs.com/svg.image?\bigcup) ![\left\{ [b_i, d_i) \mid H_k \right\}](https://latex.codecogs.com/svg.image?\left\{%20[b_i,%20d_i)%20\mid%20H_k%20\right\})

such that the ![H_k](https://latex.codecogs.com/svg.image?H_k) class is born at ![b_i](https://latex.codecogs.com/svg.image?b_i) and dies at ![d_i](https://latex.codecogs.com/svg.image?d_i).
