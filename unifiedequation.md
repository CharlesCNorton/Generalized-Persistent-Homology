...
![PH_k(X_{\text{smooth}})](https://latex.codecogs.com/svg.image?PH_k(X_{\text{smooth}})) = ![\bigcup](https://latex.codecogs.com/svg.image?\bigcup) ![\left\{](https://latex.codecogs.com/svg.image?\left\{) ![[b_i, d_i)](https://latex.codecogs.com/svg.image?[b_i,%20d_i)) such that ![H_k](https://latex.codecogs.com/svg.image?H_k) class born at ![b_i](https://latex.codecogs.com/svg.image?b_i) and dies at ![d_i](https://latex.codecogs.com/svg.image?d_i) ![\right\}](https://latex.codecogs.com/svg.image?\right\}).
